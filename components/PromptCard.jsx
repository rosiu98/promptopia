  ...
  return (
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5'>
        <div onClick={() => viewProfile(post.creator._id)} className='flex-1 flex justify-start items-center gap-3 cursor-pointer'>
        ...
        <div className='copy_btn' onClick={handleCopy}>
          <Image alt="Profile" src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'} width={12} height={12} />
